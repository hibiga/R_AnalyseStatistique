...
Si on veut l’estimer pour les 100mhaies :
...
densité de fréquence de la classe (prob = TRUE) 
si on veut comparer hist correspondant à 2 sous-pop 
si classes ne sont pas de même amplitude 
boxplot 
